...
const LESSONS = {
  ...
  ch18:[
    ...
    ,{ h:"🔍 Deep-dive: niche facts & exam traps", items:[
      ...
      "<b>Message tactics — the 6 types of appeals (lecture list, straight from the noteshells):</b> <b>Informational</b> = presents straightforward facts/features. <b>Comparative</b> = directly compares your brand's attributes/performance against a named competitor. <b>Image</b> = sells a lifestyle/feeling/status rather than facts (aspirational). <b>Fear</b> = shows a negative consequence the product helps you avoid (an accident, a health risk). <b>Humor</b> = uses comedy to be memorable and differentiate from rivals. <b>Sex</b> = suggests the product increases the user's attractiveness.",
  ...
  ch19:[
    ...
    { h:"Media Strategy", items:[
      ...
      "<b>Traditional media:</b> TV, radio, newspaper, magazine, outdoor.",
      "<b>The 4 types of TV advertising (a favorite scenario-ID pattern — read carefully, all 3 exam examples given below):</b>",
      "• <b>Network</b> — an ad bought directly through the major network for its regular, currently-airing national programming (buying a slot during a first-run episode of a network show).",
      "• <b>Spot</b> — <i>leftover</i> national ad slots that didn't sell get resold, at a discount, to <b>local/regional advertisers</b> by the local affiliate station. <i>Trap:</i> the SHOW can be a big national program (like Survivor), but if the ADVERTISER is small/local (a Gainesville scooter dealer), that's spot — the local station is selling its own unsold slot, not the network selling national time.",
      "• <b>Cable</b> — ads on cable-only channels/networks (ESPN, HGTV, Golf Channel) rather than the big broadcast networks; often more niche-targeted.",
      "• <b>Syndicated</b> — local stations <b>lease the rights</b> to air a show that already finished its original network run, as reruns (Suki watching an old rerun of \"Friends\" on her local Fox affiliate = syndicated).",
  ...
  ch20:[
    { h:"Sales Positions & Types of Selling", items:[
      ...
      "<b>Order taking</b> = processes <b>routine orders/reorders</b> for products <b>already sold</b> by the company; goal = preserve the relationship &amp; maintain sales, little persuading. <b>Outside order taker</b> = <i>visits</i> customers, replenishes reseller inventory, and <b>helps arrange/stock displays</b> (a Frito-Lay rep restocking &amp; arranging chip displays at a supermarket — this is John/American Greetings). <b>Inside order taker</b> = works from a desk/counter answering simple questions and completing transactions (a retail clerk; often <b>inbound telemarketing</b> — the customer calls a toll-free number).",
    ...
    ,{ h:"🔍 Deep-dive: niche facts & exam traps", items:[
      ...
      "<b>Presentation formats:</b> <b>Stimulus-response / canned</b> (scripted) · <b>Formula selling</b> (structured but flexible) · <b>Need-satisfaction</b> (uncover needs, then tailor — a marketing orientation; 'listen more than you talk'). <b>Canned techniques:</b> <b>Ingratiation</b> (flattery) · <b>Foot-in-the-door</b> (small ask → big ask) · <b>Door-in-the-face</b> (absurd ask → real ask) · <b>Outlined</b> (brief list of main points).",
      "<b>The 2 selling STYLES within need-satisfaction (memorize the pair):</b> <b>Adaptive selling</b> = adjusting the presentation to fit the situation — knowing WHEN to offer a solution vs. WHEN to keep asking questions. <b>Consultative selling</b> = focuses on <i>problem identification</i> — the salesperson acts like an expert consultant diagnosing the customer's problem before solving it. Together, 'adaptive selling and consultative selling' = the two styles the exam pairs with need-satisfaction (trap answers swap in canned/suggestive/confrontational selling, which are NOT part of this pair).",
